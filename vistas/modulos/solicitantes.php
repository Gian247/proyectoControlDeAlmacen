          ...
          <tbody>
            ...
            foreach ($solicitantes as $key => $value) : ?>
              ...
              <tr>
                ...
                $itemArea = "id_area";
                $itemValorArea = $value["id_area"];
                $respuestaArea = ControladorArea::ctrMostrarAreas($itemArea, $itemValorArea);

                ?>
                <td><?php echo $respuestaPerfil["perfil"]; ?></td>
                <td><?php echo $respuestaArea["nombre_area"]; ?></td>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoNombreSolicitante" placeholder="Ingresar Nombre" onkeyup="javascript:this.value=this.value.toUpperCase()" required>
              </div>
            </div>
            <!--Entrada de apellido-->
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                <input type="text" class="form-control input-lg" name="nuevoApellidoSolicitante" placeholder="Ingresar Apellido" onkeyup="javascript:this.value=this.value.toUpperCase()" required>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoCorreoSolicitante" placeholder="Ingresar Correo del Solicitante" onkeyup="javascript:this.value=this.value.toLowerCase()" required>
              </div>
            </div>
            <!--Entrada de perfil-->
            <div class="form-group">
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                <select class="form-control input-lg" name="nuevaAreaSolicitante" id="">
                  <option value="">Seleccione el area perteneciente del solicitante</option>
                  <?php
                  $areaSolicitante = ControladorArea::ctrMostrarAreas(null, null);

                  foreach ($areaSolicitante as $key => $value) : ?>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                <select class="form-control input-lg" name="editarAreaSolicitante">
                  <option value="" id="editarAreaSolicitante">Seleccione el cargo</option>
                  <?php
                  $areaSolicitante = ControladorArea::ctrMostrarAreas(null, null);
